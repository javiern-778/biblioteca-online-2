...
const libros = [
  // Aventura
  {
    ...
    descripcion:
      "Clásica novela de aventuras sobre la búsqueda de un tesoro pirata.",
    imagen: "http://localhost:3000/images/isla-tesoro.jpg",
  ...
  },
  {
    ...
    autor: "Julio Verne",
    descripcion:
      "Aventura científica sobre una expedición al interior de nuestro planeta.",
    imagen: "http://localhost:3000/images/viaje-centro-tierra.jpg",
  ...
  },
  {
    ...
    autor: "Daniel Defoe",
    descripcion:
      "Historia de supervivencia de un náufrago en una isla desierta.",
  ...
  },
  {
    ...
    descripcion:
      "Historia de venganza y redención en la Francia del siglo XIX.",
  ...
  },
  {
    ...
    autor: "Emily Brontë",
    descripcion:
      "Intensa historia de amor y venganza en los páramos de Yorkshire.",
  ...
  },
  {
    ...
    descripcion:
      "Novela gótica sobre una institutriz y su amor por el misterioso Mr. Rochester.",
  ...
  },
  {
    ...
    autor: "John Green",
    descripcion:
      "Conmovedora historia de amor entre dos adolescentes con cáncer.",
  ...
  },
  {
    ...
    autor: "Stieg Larsson",
    descripcion:
      "Primer libro de la trilogía Millennium sobre un periodista y una hacker.",
  ...
  },
  {
    ...
    autor: "Stephen King",
    descripcion:
      "Historia de un grupo de niños que enfrentan a una entidad malévola.",
  ...
  },
  {
    ...
    autor: "Mary Shelley",
    descripcion:
      "Clásico sobre un científico que crea vida artificial con consecuencias trágicas.",
  ...
  },
  {
    ...
    autor: "Stephen King",
    descripcion:
      "Un escritor y su familia cuidan un hotel aislado con presencia sobrenatural.",
  ...
  // Ciencia Ficción
  {
    ...
    autor: "George Orwell",
    descripcion:
      "Distopía sobre un estado totalitario que controla todos los aspectos de la vida.",
  ...
  },
  {
    ...
    autor: "Ray Bradbury",
    descripcion:
      "Futuro donde los libros están prohibidos y los bomberos los queman.",
  ...
  },
  {
    ...
    autor: "Aldous Huxley",
    descripcion:
      "Visión futurista de una sociedad controlada por el placer y la tecnología.",
  ...
  },
  {
    ...
    descripcion:
      "Historia de un niño genio entrenado para defender a la Tierra.",
  ...
  // Fantasía
  {
    ...
    autor: "J.R.R. Tolkien",
    descripcion:
      "Épica fantasía sobre la búsqueda para destruir un anillo maligno.",
  ...
  },
  {
    ...
    descripcion:
      "Primer libro de la saga de fantasía épica que inspiró la serie Game of Thrones.",
  ...
  },
  {
    ...
    autor: "C.S. Lewis",
    descripcion:
      "Serie de fantasía sobre un mundo mágico accesible a través de un armario.",
  ...
  },
  {
    ...
    autor: "J.R.R. Tolkien",
    descripcion:
      "Aventura de un hobbit que se une a una búsqueda para recuperar un tesoro.",
  ...
  // Histórica
  {
    ...
    autor: "Ken Follett",
    descripcion:
      "Novela histórica sobre la construcción de una catedral en la Edad Media.",
  ...
  },
  {
    ...
    autor: "León Tolstói",
    descripcion:
      "Obra maestra sobre la sociedad rusa durante las guerras napoleónicas.",
  ...
  },
  {
    ...
    descripcion:
      "Drama familiar que abarca varias generaciones en Latinoamérica.",
  ...
  },
  {
    ...
    autor: "Harper Lee",
    descripcion:
      "Drama sobre racismo e injusticia en el sur de Estados Unidos.",
  ...
  },
  {
    ...
    descripcion:
      "Drama sobre una familia de agricultores durante la Gran Depresión.",
  ...
  },
  {
    ...
    autor: "León Tolstói",
    descripcion:
      "Tragedia sobre el adulterio y la sociedad rusa del siglo XIX.",
  ...
  },
  {
    ...
    autor: "Ana Frank",
    descripcion:
      "Diario personal de una niña judía escondida durante el Holocausto.",
  ...
  },
  {
    ...
    autor: "Adolf Hitler",
    descripcion:
      "Autobiografía y manifiesto político del líder nazi. [Contenido controvertido]",
  ...
  },
  {
    ...
    descripcion:
      "Historia epistolar sobre un adolescente que navega por la vida.",
  ...
  },
  {
    ...
    descripcion:
      "Fábula filosófica sobre un niño que viaja por diferentes planetas.",
  ...
  },
  {
    ...
    descripcion:
      "Novela gráfica autobiográfica sobre crecer durante la Revolución Iraní.",
  ...
  // Comedia
  {
    ...
    descripcion:
      "Novela satírica sobre un caballero enloquecido por leer demasiados libros de caballerías.",
  ...
  },
  {
    ...
    descripcion:
      "Comedia sobre un ángel y un demonio que intentan evitar el Apocalipsis.",
  ...
  },
  {
    ...
    autor: "Jeff Kinney",
    descripcion:
      "Novela gráfica humorística sobre las desventuras de un preadolescente.",
